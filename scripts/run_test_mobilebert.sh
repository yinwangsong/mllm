...
adb.exe push ../bin-arm/demo_test_bert_simulated_by_llama /data/local/tmp/mllm/bin/
...
adb.exe shell "cd /data/local/tmp/mllm/bin && chmod 777 ./demo_test_bert_simulated_by_llama && ./demo_test_bert_simulated_by_llama --prompt_len 1024"